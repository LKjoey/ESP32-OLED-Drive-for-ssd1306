...
// 合宙 ESP32C3 开发板，I2C引脚
#define SCL_PIN  5  	// I2C时钟线引脚，
#define SDA_PIN  4  	// I2C数据线引脚，


// ESP12F (ESP8266)， I2C引脚
// #define SCL_PIN  5  	// I2C时钟线引脚，
// #define SDA_PIN  4  	// I2C数据线引脚，
...
void OLED_W_SCL(uint8_t BitValue)
{
	...
	// GPIO_WriteBit(GPIOB, GPIO_Pin_8, (BitAction)BitValue); 	原STM32
	
	digitalWrite(SCL_PIN, BitValue);		// ESP32
...
void OLED_W_SDA(uint8_t BitValue)
{
	...
	// GPIO_WriteBit(GPIOB, GPIO_Pin_9, (BitAction)BitValue);	原STM32

    digitalWrite(SDA_PIN, BitValue);	// ESP32
	/*如果单片机速度过快，可在此添加适量延时，以避免超出I2C通信的最大速度*/
	//...
}
